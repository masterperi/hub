          ...
          <View style={[styles.activeSessionCard, { backgroundColor: theme.backgroundDefault }]}>
            <View style={styles.activeSessionHeader}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <ThemedText type="bodySmall" secondary>Active Leave Session for {user?.hostelBlock}</ThemedText>
              </View>
            </View>
            ...
            <View style={[styles.leaveBanner, { backgroundColor: Colors.status.warning + '15', borderColor: Colors.status.warning + '40' }]}>
              ...
              <View style={{ flex: 1 }}>
                <ThemedText type="bodySmall" style={{ fontWeight: '700', color: Colors.status.warning }}>
                  Hostel Leave Window: {activeSession.leaveWindowLabel}
                </ThemedText>
          ...
          <View style={[styles.requestCard, { backgroundColor: theme.backgroundDefault }]}>
            ...
            {item.imageUrl ? (
              <View style={styles.imagePreviewContainer}>
                <ThemedText type="caption" secondary>Attachment:</ThemedText>
                <ThemedText type="caption" style={{ color: Colors.primary.main }}>View Image (Admin will see this)</ThemedText>
              </View>
            ) : null}
            {item.adminRemarks ? (
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: theme.backgroundRoot }]}>
            ...
            <KeyboardAwareScrollViewCompat contentContainerStyle={styles.modalForm}>
              ...
              <ThemedText type="bodySmall" secondary style={styles.label}>Image URL (Optional)</ThemedText>
              <TextInput
