            ...
            <View style={[styles.leaveBanner, { backgroundColor: Colors.status.warning + '15', borderColor: Colors.status.warning + '40' }]}>
              ...
              <View style={{ flex: 1 }}>
                <ThemedText type="bodySmall" style={{ fontWeight: '700', color: Colors.status.warning }}>
                  Leave Declared: {activeSession.leaveWindowLabel}
                </ThemedText>
                  ...
                  >
                    <View style={styles.announcementHeader}>
                      <View style={[styles.announcementIcon, {
                        ...
                        <Feather
                          name={announcement.isEmergency ? "alert-triangle" : "bell"}
                          size={20}
                          color={announcement.isEmergency ? Colors.status.error : Colors.primary.main}
                        />
                      </View>
