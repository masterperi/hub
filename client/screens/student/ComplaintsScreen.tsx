        ...
        renderItem={({ item, index }) => (
          <Animated.View entering={FadeInDown.delay(200 + index * 50)}>
            <View style={[styles.complaintCard, { backgroundColor: theme.backgroundDefault }]}>
              ...
              {item.photoUrl ? (
                <Pressable style={styles.attachmentButton} onPress={() => { /* View full image logic could go here */ }}>
                  <Image source={{ uri: item.photoUrl }} style={styles.attachmentPreview} />
                </Pressable>
              ) : null}
              {item.adminRemarks ? (
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: theme.backgroundRoot }]}>
            ...
            <KeyboardAwareScrollViewCompat contentContainerStyle={styles.modalForm}>
              ...
              <ThemedText type="bodySmall" secondary style={styles.label}>Attachment (Image Link)</ThemedText>
              <View style={{ backgroundColor: theme.backgroundDefault, borderColor: theme.border, borderWidth: 1, borderRadius: BorderRadius.md, flexDirection: 'row', alignItems: 'center', paddingHorizontal: Spacing.md, height: 50, marginBottom: Spacing.sm }}>
              ...
              {image ? (
                <View style={{ marginTop: Spacing.md, position: 'relative' }}>
                  <Image source={{ uri: image }} style={{ borderRadius: BorderRadius.md, height: 150, width: '100%' }} />
                  <Pressable style={{ position: 'absolute', top: -10, right: -10 }} onPress={() => setImage(null)}>
