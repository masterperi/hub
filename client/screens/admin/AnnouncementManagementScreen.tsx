  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <FlatList
        ...
        contentContainerStyle={[styles.listContent, { paddingTop: headerHeight + Spacing.lg, paddingBottom: tabBarHeight + Spacing.xl + 80 }]}
            ...
            <KeyboardAwareScrollViewCompat contentContainerStyle={styles.modalForm}>
              ...
              <View style={styles.switchContainer}>
                <View style={styles.switchRow}>
                  ...
                  <Switch value={isEmergency} onValueChange={val => { setIsEmergency(val); if (val) setIsHoliday(false); }} trackColor={{ true: Colors.status.error }} />
                </View>
                ...
                <View style={styles.switchRow}>
                  ...
                  <Switch value={isHoliday} onValueChange={val => { setIsHoliday(val); if (val) setIsEmergency(false); }} trackColor={{ true: Colors.status.success }} />
                </View>
              </View>
